...
namespace CPRDGOLD.mappers
{
    internal class ProcedureOccurrence : Mapper<ProcedureOccurrence>
    {
        ...
        protected override void LoadData(dynamic stemSource)
        {
            string[] cols =
            {
                "provider_id", "procedure_occurrence_id", "procedure_source_value",
                "person_id", "procedure_source_concept_id", "procedure_date", "procedure_concept_id",
            ...
            {
                (stemSource as StemTableMerger)?.LoopAllData(stem =>
                {
